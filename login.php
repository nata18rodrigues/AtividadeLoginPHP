                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" name="loginform" method="post" action="userauthentication.php">
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user"
                                                id="exampleInputPassword" placeholder="Informe sua senha" name="senha">
                                        </div>
                                        <div class="form-group">
